...
format_names = function(names){
	plyr::revalue(names, replace = c(
		...
		"Jul_Sep_mean_mean"="Summer mean",
                "CDD_0_1_3"=paste0("CDD >0","\U00B0", "C Jan-Mar"),
                "CDD_0_4_6"=paste0("CDD >0","\U00B0", "C Apr-Jun"),
                "CDD_10_4_6"=paste0("CDD >10","\U00B0", "C Apr-Jun"),
                "SD_1_3"="SD wkly T Jan-Mar",
                "SD_4_6"="SD wkly T Apr-Jun",
                "mean_1_3"="MEAN mo mn Jan-Mar",
                "max_1_3"="MAX mo mn Jan-Mar",
                "min_1_3"="MIN mo mn Jan-Mar",
                "mean_4_6"="MEAN mo mn Apr-Jun",
                "max_4_6"="MAX mo mn Apr-Jun",
                "min_4_6"="MIN mo mn Apr-Jun",
                "mean_7_9"="MEAN mo mn July-Sept",
                "max_7_9"="MAX mo mn July-Sept",
                "min_7_9"="MIN mo mn July-Sept",
                "mean_10_12"="MEAN mo mn Nov-Dec",
                "max_10_12"="MAX mo mn Nov-Dec",
                "min_10_12"="MIN mo mn Nov-Dec",                                                
                "max_warmest"="MAX T warmest mo",
                "min_coldest"="MIN T coldest mo",
